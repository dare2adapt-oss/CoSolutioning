...
headerBrand.innerHTML = `<img class="brand-logo" src="${p}assets/images/logo-cosolutioning-black.png" alt="CoSolutioning"><span class="brand-copy"><small>The Collaborative Solutioning Framework</small></span>`;
