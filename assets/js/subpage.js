...
const rolesContent = `
  <article class="article-content">
    ...
    <figure class="content-figure"><img src="../assets/images/Combinacion_conocimiento_habilidades.jpg" alt="Combinación de conocimiento, habilidades y capacidades entre humanos e inteligencia artificial"><figcaption>Combinación de conocimiento, habilidades y capacidades Humano + IA.</figcaption></figure>
    ...
    <figure class="content-figure"><img src="../assets/images/diseno_organizacion_humano_ia.jpg" alt="Diseño organizacional de equipos Humano más IA y capacidades transversales"><figcaption>Diseño organizacional de equipos Humano + IA y capacidades transversales.</figcaption></figure>
    ...
    <figure class="content-figure"><img src="../assets/images/crew_manager.jpg" alt="El Crew Manager coordinando equipos solucionadores"><figcaption>El rol del Crew Manager, los equipos que conforman el Crew y la forma como interactúan.</figcaption></figure>
...
const eventsContent = `
  <article class="article-content">
    ...
    <figure class="content-figure"><img src="../assets/images/linea_de_tiempo.jpg" alt="Línea de tiempo de los eventos y el OKR-Based Roadmap"><figcaption>Línea de tiempo de los eventos y el OKR-Based Roadmap.</figcaption></figure>
  </article>`;
...
headerBrand.setAttribute('aria-label', 'CoSolve, inicio');
headerBrand.innerHTML = `<picture class="brand-logo"><source media="(max-width: 950px)" srcset="${p}assets/images/logo-cosolve-mark.png"><img src="${p}assets/images/logo-cosolve-header.png" alt="CoSolve"></picture><span class="brand-copy"><small>The Collaborative Solutioning Framework</small></span>`;
...
favicon.href = `${location.pathname.includes('/en/') || location.pathname.includes('/es/') ? '../' : ''}assets/images/favicon-cosolve.png`;
